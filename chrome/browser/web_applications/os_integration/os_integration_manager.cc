...
void OsIntegrationManager::SetSubsystems(WebAppSyncBridge* sync_bridge,
  ...
  auto uninstallation_via_os_settings_sub_manager = std::make_unique<UninstallationViaOsSettingsSubManager>(*registrar);
  ...
  sub_managers_.push_back(std::move(uninstallation_via_os_settings_sub_manager));
}
