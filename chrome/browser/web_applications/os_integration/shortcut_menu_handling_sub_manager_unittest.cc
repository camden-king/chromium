...
TEST_P(ShortcutMenuHandlingSubManagerTest, TestConfigure) {
  ...
  if (AreOsIntegrationSubManagersEnabled()) {
    ASSERT_TRUE(os_integration_state.shortcut_menus().shortcut_menu_info_size() == num_menu_items);

    ASSERT_TRUE(os_integration_state.shortcut_menus().shortcut_menu_info(0).title() == "Test App");
    ASSERT_TRUE(os_integration_state.shortcut_menus().shortcut_menu_info(0).url() ==
                "https://example.com/path/index.html");

    ASSERT_TRUE(os_integration_state.shortcut_menus().shortcut_menu_info(0).icon_data_any_size() ==
                2);
    ASSERT_TRUE(
        os_integration_state.shortcut_menus().shortcut_menu_info(0).icon_data_any(0).icon_size() ==
        icon_size::k64);
    ASSERT_TRUE(
        os_integration_state.shortcut_menus().shortcut_menu_info(0).icon_data_any(0).has_timestamp());
    ASSERT_TRUE(
        os_integration_state.shortcut_menus().shortcut_menu_info(0).icon_data_any(1).icon_size() ==
        icon_size::k128);
    ASSERT_TRUE(
        os_integration_state.shortcut_menus().shortcut_menu_info(0).icon_data_any(1).has_timestamp());

    ASSERT_TRUE(
        os_integration_state.shortcut_menus().shortcut_menu_info(0).icon_data_maskable_size() == 2);
    ASSERT_TRUE(os_integration_state.shortcut_menus().shortcut_menu_info(0)
    ...
    ASSERT_TRUE(
        os_integration_state.shortcut_menus().shortcut_menu_info(0).icon_data_monochrome_size() == 2);
    ASSERT_TRUE(os_integration_state.shortcut_menus().shortcut_menu_info(0)
    ...
    ASSERT_TRUE(os_integration_state.shortcut_menus().shortcut_menu_info(1).icon_data_any_size() ==
                2);
    ASSERT_TRUE(
        os_integration_state.shortcut_menus().shortcut_menu_info(1).icon_data_any(0).icon_size() ==
        icon_size::k64);
    ASSERT_TRUE(
        os_integration_state.shortcut_menus().shortcut_menu_info(1).icon_data_any(0).has_timestamp());
    ASSERT_TRUE(
        os_integration_state.shortcut_menus().shortcut_menu_info(1).icon_data_any(1).icon_size() ==
        icon_size::k128);
    ASSERT_TRUE(
        os_integration_state.shortcut_menus().shortcut_menu_info(1).icon_data_any(1).has_timestamp());

    ASSERT_TRUE(
        os_integration_state.shortcut_menus().shortcut_menu_info(1).icon_data_maskable_size() == 2);
    ASSERT_TRUE(os_integration_state.shortcut_menus().shortcut_menu_info(1)
                    .icon_data_maskable(0)
                    .icon_size() == icon_size::k64);
    ASSERT_TRUE(os_integration_state.shortcut_menus().shortcut_menu_info(1)
                    .icon_data_maskable(0)
    ...
    ASSERT_TRUE(
        os_integration_state.shortcut_menus().shortcut_menu_info(1).icon_data_monochrome_size() == 2);
    ASSERT_TRUE(os_integration_state.shortcut_menus().shortcut_menu_info(1)
                    .icon_data_monochrome(0)
                    .icon_size() == icon_size::k64);
    ASSERT_TRUE(os_integration_state.shortcut_menus().shortcut_menu_info(1)
