...
#include "chrome/browser/unexpire_flags_gen.inc"
    ...
    {"enable-desktop-pwas-detailed-install-dialog",
     ...
     flag_descriptions::kSkipServiceWorkerCheckInstallOnlyDescription, kOsAll,
     FEATURE_VALUE_TYPE(webapps::features::kSkipServiceWorkerCheckInstallOnly)},
     {"enable-skip-service-worker-check-install-for-prompt",
     flag_descriptions::kSkipServiceWorkerForInstallPromptName,
     flag_descriptions::kSkipServiceWorkerForInstallPromptDescription, kOsAll,
